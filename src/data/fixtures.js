...
export const fixtures = [
  {
    ...
    slots: [
      { productId: 'aerovista-apex-vintage-tee', x: 14, y: 47.5, scale: 1.17, tilt: -1 },
      { productId: 'aerovista-apex-signal-sweatshirt', x: 39, y: 44.2, scale: 1.09, tilt: 0 },
      { productId: 'aerovista-apex-glitch-tee-black', x: 64, y: 40.9, scale: 1.01, tilt: 0 },
      { productId: 'aerovista-shadow-pattern-hoodie', x: 89, y: 37.7, scale: .93, tilt: 1 },
      { productId: 'aerovista-shadow-pattern-long-sleeve-tee', x: 45, y: 72.8, scale: 1.03, tilt: -1 },
      { productId: 'shadow-wear-ghost-ridge', x: 65, y: 67.0, scale: .98, tilt: 0 },
      { productId: 'aerovista-apex-pattern-bomber-jacket', x: 85, y: 61.3, scale: .93, tilt: 1 },
    ],
  },
  {
    id: 'right-wall-rack',
    ...
    slots: [
      ...
      { productId: 'architect-built-different-hoodie-black', x: 61, y: 44.2, scale: 1.09, tilt: 0 },
      { productId: 'drafted-a-premium-sweatshirt', x: 86, y: 47.5, scale: 1.17, tilt: 1 },
      { productId: 'aerovista-core-hoodie', x: 15, y: 61.3, scale: .93, tilt: -1 },
      { productId: 'aerovista-division-hoodie', x: 45, y: 69.8, scale: 1.03, tilt: 0 },
      { productId: 'aerovista-the-blue-witness-urban-hoodie-black', x: 75, y: 78.3, scale: 1.13, tilt: 1 },
    ],
  },
  {
    id: 'hat-shelf',
